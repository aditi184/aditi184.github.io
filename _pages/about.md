...
<div class="row">
    <div class="col-md-2 my-auto">
        <img class="sideimg" src="{{ '/images/sides/unlearning.png' | relative_url }}" alt="Unlearning paper">
    </div>
    <div class="col-lg-10">
        <p class="paper my-2 pl-2">
...
<div class="row">
    <div class="col-md-2 my-auto">
        <img class="sideimg" src="{{ '/images/sides/deepseekpaper.png' | relative_url }}" alt="Thoughtology paper">
    </div>
    <div class="col-lg-10">
        <p class="paper my-2 pl-2">
